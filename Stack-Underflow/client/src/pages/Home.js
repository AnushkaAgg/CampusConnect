      ...
      <div className="dark:bg-primary-light bg-gray-100 p-10 pt-24 min-h-screen transition duration-500" >
        <div className="grid grid-cols-4 gap-4">
          ...
          <div className="col-span-2 justify-self-stretch">
            <form onSubmit={(e) => handleSearch(e)}>
              <div className="relative mb-4">
                <input
                  type="text"
                  className="bg-card-orange py-3 w-full pr-8 pl-5 rounded z-0 focus:shadow focus:outline-none text-gray-300"
            ...
            <div className="flex">
              <button
                className="bg-card-dark hover:bg-gray-700 border-gray-900 border-r-2 border-b-2 py-3 w-1/2 text-center text-white font-semibold focus:outline-none" style={{backgroundColor: "coral"}}
                onClick={() => setFeatured(false)}
              >
                Recent Posts
              </button>
              <button
                className="bg-card-dark hover:bg-gray-700 border-black py-3 w-1/2 border-b-2 text-center text-white font-semibold focus:outline-none" style={{backgroundColor: "coral"}}
          ...
          <div className="col-span-1 justify-self-center">
            <div className="bg-card-dark p-6 rounded-xl mb-2 text-white" style={{backgroundColor: "coral"}}>
              <div className="font-semibold">New Post</div>
              <Link to="/createPost">
                <button className="mt-4 py-1 px-20 border-white border-2 rounded-lg" style={{backgroundColor: "coral"}}>
                  Create Post
                </button>
              </Link>
            </div>
